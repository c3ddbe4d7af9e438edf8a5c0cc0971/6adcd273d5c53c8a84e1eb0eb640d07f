...
$route->get('/user_detail','AdminController@get_user_detail');
...
$route->get('/upload_user_profile','AdminController@upload_user_profile');
$route->post('/post_user_profile','AdminController@post_user_profile');
$route->get('/upload_user_sign','AdminController@upload_user_sign');
$route->post('/post_user_sign','AdminController@post_user_sign');
...
$route->get('/user_details','AdminController@get_user_details'); //user details for the exam
$route->get('/import_user_exam','AdminController@get_user_exam');
$route->post('/post_exam_user_csv','AdminController@post_exam_user_csv'); //csv import users for exam
//************************************** Quiz Log Ends **********************************//

// ************************ Exam Instructions Starts ***********************************//
...
// ******************* Route For User Result Ends *****************************//

// *********************center allocation Route Starts ***********************//
...
// *********************Center Allocation Route Ends********************//

// *********************Lab Allocation Route Starts********************//
...
$route->post('/allocate_center_lab_to_users','AdminController@allocate_center_lab_to_users');
$route->post('/un_allocate_center_lab_to_users','AdminController@un_allocate_center_lab_to_users');
$route->get('/edit_labs','AdminController@edit_labs');
$route->post('/update_lab','AdminController@update_lab');
// ******************Lab Allocation Route Ends*********************//

//****************** demo export csv files Stars******************//
