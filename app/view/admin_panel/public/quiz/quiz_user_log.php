<?php
$quiz_user_log=$data['quiz_user_log'];
// $exam_id=$data['exam_id'];
$admin=$data['admin'];
// echo "<pre>";print_r($quiz_user_log);die;
?>
<!doctype html>
<html>
<head>
  ...
  <div class="outer">
    <div class="inner bg-light lter">
      <div class="text-center">
              <ul class="stats_box">
                <?php if($quiz_user_log!='null') {?>
                  <?php foreach($quiz_user_log as $key => $value) {?>
          
                      <li class="list_change" style="width:60%;">
                        <div class="sparkline bar_week"></div>
                        <div class="stat_text">
                          <a href="user_details?user_id=<?php echo $value->user_id;?>"><strong><?php echo $value->name?></strong></a>
                        </div>
                        <span style="position:relative;left:166px!important;top:-6px;">
                        <a href="/view?user_id=<?php echo $value->user_id?>" style='text-decoration:none;'>
                          <button type="button" class="btn btn_position btn-warning">
                            <i class="fa fa-pencil-square" aria-hidden="true"></i>User Logs</button>
                          </a>
                           <a href="/result_details?user_id=<?php echo $value->user_id?>" style='text-decoration:none;'>
                          <button type="button" class="btn btn_position btn-success">
                            <i class="fa fa-minus-circle" aria-hidden="true"></i>User Questions</button>
                          </a>
                           <a href="/question_manager?quiz_id=<?php echo $value->id?>">
                          <button type="button" class="btn btn_position btn-primary">
                            <i class="fa fa-minus-circle" aria-hidden="true"></i>Score</button>
                          </a></span>
