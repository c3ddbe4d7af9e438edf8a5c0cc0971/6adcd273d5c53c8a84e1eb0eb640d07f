...
// echo '<pre>';print_r($authority_id);die;
                    ...
                    <div class="box">
                        <header>
                            ...
                            <a  href="/add_quiz?exam_id=<?php echo $exam_id?>">
                                <button type="button" class="btn btn-success pull-right"> Create Exam </button></a>
                            </header>
                                    ...
                                    <tbody>
                                        ...
                                        <?php if($quizzes!='null') { ?>
                                            <?php foreach($quizzes as $key => $value) {?>
                                                <tr>
                                                    <td><?php echo ++$i ;?></td>
                                                    <td><a href="/quiz_details?quiz_id=<?php echo $value->id?>"><?php echo $value->name ;?></a></td>
                                                    ...
                                                    <td>
                                                        <a href="/edit_quiz?exam_id=<?php echo $exam_id ?>&quiz_id=<?php echo $value->id?> ">
                                                            ...
                                                            <form onSubmit="if(!confirm('Do you really want to delete?')){return false;}" action="<?php echo '/delete_quiz?exam_id='.$exam_id.'&quiz_id='.$value->id ?>" method="POST" class="smart-forms">
                                                 ...
                                                 <a  href="examination?authority_id=<?=$authority_id[0]->authority_id;?>">
