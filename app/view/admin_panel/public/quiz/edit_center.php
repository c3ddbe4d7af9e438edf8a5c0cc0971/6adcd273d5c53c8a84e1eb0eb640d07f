                    ...
                    <div class="box">
                        ...
                        <div id="collapse3" class="body">
                            <?php foreach($centers as $key=>$value) {?>
                                <form action="<?php echo '/update_center?center_id='.$center_id.'&quiz_id='.$quiz_id ?>" method="POST" id="edit_center" enctype="multipart/form-data">
                              ...
                              <a  href="centers?quiz_id=<?=$quiz_id;?>">
