                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div id="collapse3" class="body">
                            <form class="smart-forms" action="/post_quiz?exam_id=<?php echo $exam_id?>" method="POST" id="add_quiz" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="control-label col-lg-4"> Exam Name:</label>
                                    <div class="col-lg-8">
                                        <input type="text" id="name" name="name" class="form-control col-lg-6" placeholder="Exam Name">
                                    </div>
                                    <br>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="title" name="title" class="form-control col-lg-6" placeholder="Title">
                                    </div>
                                    <br>
                                </div>
                                 <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="time_duration" name="time_duration" class="form-control col-lg-6" placeholder="Time in Minutes">
                                    </div>
                                    <br>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="total_ques" name="total_ques" class="form-control col-lg-6" placeholder="Total Questions">
                                    </div>
                                    <br>
                                </div>
                                <br>
...
$("#add_quiz").validate({
    ...
    messages: {
        name:
        {
            ...
            name: "Please enter a valid exam name",
        },
