                ...
                <div class="panel">
                  <div class="panel-content">
                      ...
                      <a href="/centers?quiz_id=<?=$quiz_id?>" class="btn btn-primary col-sm-3 <?php if($actual_link=='/centers?quiz_id='.$quiz_id) {echo 'active';} ?>">
                        ...
                        <a href="/alloted_users?center_code=<?=$center_id?>&quiz_id=<?=$quiz_id?>" class="btn btn-primary col-sm-3 <?php if($actual_link=='/alloted_users?center_code='.$center_id.'&quiz_id='.$quiz_id) {echo 'active';} ?>">
                        ...
                        <a href="/user_list?quiz_id=<?=$quiz_id?>" class="btn btn-primary col-sm-3 <?php if($actual_link=='/user_list?quiz_id='.$quiz_id) {echo 'active';} ?>">
                          ...
                          <p>Exam User</p>
                            ...
                            <div id="collapse4" class="body">
                             ...
                             <form action="/un_allocate_center_to_users?center_id=<?=$center_id?>&quiz_id=<?=$quiz_id?>" method="POST">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if($allocated_users!='null') { ?>
                                            <?php foreach($allocated_users as $key => $value) {?>
                                                <tr>
                                                <td><input type="checkbox" name="users[]" value="<?php echo $value->id;?>" <?php foreach($allocated_users as $key1 => $value1){ if($value1->user_id==$value->user_id){ echo 'checked';}}?>></td>
                                                    <td><?php echo ++$i ;?></td>
                                                    ...
                                                    <?php } else {?>
                                                        <td>
                                                            ...
                                                            <div class="stat_text">
                                                                <strong>Users are not alloted center yet</strong>
                                                            </div>
                                                        </td>
                                                        <?php }?>
                                                    </tbody>
                                ...
                                <!-- <a  href="quiz_details?quiz_id=<?=$quiz_id;?>">
                                <button type="button" class="btn btn-primary"> Back </button></a> -->
                                                 <button type="submit" name="update_center" class="btn btn-primary"> Un-Allocate Center</button>
