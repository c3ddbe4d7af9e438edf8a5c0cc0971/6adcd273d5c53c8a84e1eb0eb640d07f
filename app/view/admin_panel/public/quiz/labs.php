<?php
$center_labs=$data['center_labs'];
$center_id=$data['center_id'];
$quiz_id=$data['quiz_id'];
//echo '<pre>';print_r($center_labs); die;
                             ...
                             <form action="/allocate_center_to_users?center_id=<?=$center_id?>&quiz_id=<?=$quiz_id;?>" method="POST">
                                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $i=0; ?>
                                        <?php if($center_labs!='null') { ?>
                                            <?php foreach($center_labs as $key => $value) {?>
                                                <tr>
                                                <!--<td><input type="checkbox" name="users[]" value="<?php //echo $value->id;?>" <?php //foreach($allocated_users as $key1 => $value1){ if($value1->user_id==$value->id){ echo 'checked';}}?>></td>-->
                                                    <td><?php echo ++$i ;?></td>
                                                    <td><a href="/lab_users?center_id=<?=$center_id?>&quiz_id=<?=$quiz_id?>&center_lab_id=<?=$value->id?>&lab_id=<?=$value->id?>"><?php echo $value->lab_name ;?></a></td>
                                                    <td><?php echo $value->lab_code ;?></td>
                                                    <td><?php echo $value->lab_capacity ;?></td>
                                                    <td><?php echo $value->center_name ;?></td>
                                                    <td>
                                                        <a href="/edit_labs?lab_id=<?php echo $value->lab_id?>&quiz_id=<?=$quiz_id?>&center_id=<?=$center_id?>">
                                                ...
                                                <a href="/add_labs?quiz_id=<?=$quiz_id?>&center_id=<?=$center_id?>">
                                                            <button type="button" class="btn btn-success">
                                                                <i class="fa fa-pencil-square" aria-hidden="true"></i>Add Labs </button>
                                                            </a>
                                                </form>
                                            </div> 
