                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div id="collapse3" class="body">
                            <form class="smart-forms" action="/post_center?quiz_id=<?php echo $quiz_id?>" method="POST" id="add_center" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="control-label col-lg-4"> Center Name:</label>
                                    <div class="col-lg-8">
                                        <input type="text" id="name" name="name" class="form-control col-lg-6" placeholder="Center Name">
                                    </div>
                                    <br>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="code" name="code" class="form-control col-lg-6" placeholder="Center Code">
                                    </div>
                                    <br>
                                </div>
                                 <div class="form-group">
