                    ...
                    <div class="box">
                        ...
                        <div id="collapse3" class="body">
                            <?php foreach($lab as $key=>$value) {?>
                                <form action="<?php echo '/update_lab?lab_id='.$value->id.'&quiz_id='.$quiz_id?>&center_id=<?=$center_id?>" method="POST" id="edit_center" enctype="multipart/form-data">
                                     <div class="form-group">
                                        <label class="control-label col-lg-4"> Center Name:</label>
                                        <div class="col-lg-8">
                                            <input type="text" id="name" name="name" placeholder="Center Name" value="<?php echo $value->name; ?>" class="form-control col-lg-6">
                                        </div>
                                        <br>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label class="control-label col-lg-4"> Center Code:</label>
                                        <div class="col-lg-8">
                                            <input type="text" id="code" name="code" placeholder="Center Code" value="<?php echo $value->code; ?>" class="form-control col-lg-6">
                                        </div>
                                        <br>
                                    </div>
                                    <br>
                                     <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="capacity" name="capacity" placeholder="Capacity" value="<?php echo $value->capacity; ?>" class="form-control col-lg-6">
                                        </div>
                                        <br>
                                    </div>
                                    <br>
                             ...
                             <a  href="/labs?center_id=<?=$center_id?>&quiz_id=<?=$quiz_id;?>">
...
$("#edit_center").validate({
    ...
    messages: {
        name: "Please enter the center name",
