            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div class="body">
                            <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="/post_exam_user_csv?quiz_id=<?=$quiz_id?>" class="form-horizontal" method="post" id="user_csv" enctype="multipart/form-data">
                   ...
                   <button class="btn btn-danger" id="delete" type="button">Truncate Users Table</button>
                </div>
...
<script type="text/javascript">
    ...
    $('#delete').click(function() {
        ...
        var ans = confirm('Do you want to truncate users table?');
        if(ans==true)
        {
             //alert(quiz_id);
               $.ajax({
               type: "GET",
               url: "/truncate_users_tbl",
               data: 'quiz_id='+ quiz_id,
               cache: false,
               success: function(response) {
                    alert('users and user_quizes tables dropped successfully');
                },
