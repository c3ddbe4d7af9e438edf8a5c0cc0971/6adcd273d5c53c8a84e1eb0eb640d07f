                  ...
                  <?php foreach($quizzes as $key => $value) {?>
                    <a href="/quiz?exam_id=<?php echo $value->id; ?>">  
                      <li class="list_change" style="width:60%;">
                        ...
                        <div class="stat_text">
                          <a href="quiz_details?quiz_id=<?php echo $value->id;?>"><strong><?php echo $value->name?></strong>
                        </div>
                        </li>
                        <a href="/user_list?quiz_id=<?php echo $value->id?>">
                          <button type="button" class="btn btn_position btn-warning" style="position:relative;right:306px!important;">
                            <i class="fa fa-pencil-square" aria-hidden="true"></i> user list </button>
                          </a>
                           <a href="/question_manager?quiz_id=<?php echo $value->id?>">
                          <button type="button" class="btn btn_position btn-success" style="margin-top:-57px!important;">
                            <i class="fa fa-minus-circle" aria-hidden="true"></i> Question list </button>
                          </a>
                        <?php }?>
                        <?php } else {?>
                          <li>
