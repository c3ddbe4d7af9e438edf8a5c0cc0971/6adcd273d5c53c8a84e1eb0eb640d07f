                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div id="collapse3" class="body">
                            <form class="smart-forms" action="/post_labs?quiz_id=<?php echo $quiz_id?>&center_id=<?=$center_id?>" method="POST" id="add_center" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="control-label col-lg-4"> Lab Name:</label>
                                    <div class="col-lg-8">
                                        <input type="text" id="name" name="name" class="form-control col-lg-6" placeholder="Lab Name">
                                    </div>
                                    <br>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-lg-4"> Lab Code:</label>
                                    <div class="col-lg-8">
                                        <input type="text" id="code" name="code" class="form-control col-lg-6" placeholder="Lab Code">
                                    </div>
                                    <br>
                                </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="capacity" name="capacity" class="form-control col-lg-6" placeholder="Capacity">
                                    </div>
                                    <br>
                                </div>
                                <br>
                            ...
                            <!-- <p><span></span> is already exists in database. Enter this email in the textbox to check.</p> -->
                        </div>
