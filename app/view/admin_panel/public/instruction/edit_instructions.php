...
$instructions=$data['instructions'];
 // echo '<pre>';print_r($instructions);die;
?>
<!doctype html>
<html>
<head>
        ...
        <div class="col-lg-12">
          <div class="box">
            ...
            <?php foreach ($instructions as $key => $value) {?>
              ...
              <form class="smart-forms" action="/update_instruction?quiz_id=<?php echo $quiz_id?>&instruction_id=<?php echo $value->id?>" method="POST" id="add_instruction">

              <div class="form-group">
                  <label class="control-label col-lg-4"> English Instructions:</label>
                  <div class="col-lg-8">
                    <textarea id="instruction" class="gui-input" name="instruction" placeholder="English Passage"><?php echo $value->instruction;?></textarea>
                  </div>
                  <br>
                </div>
                <div class="form-group">
                  <label class="control-label col-lg-4">hindi Instructions:</label>
                  <div class="col-lg-8">
                    <textarea id="instruction_h" class="gui-input" name="instruction_h" placeholder="Hindi Instructions"><?php echo $value->instruction_h;?></textarea>
                  </div>
                  <br>
                </div> &nbsp;
                 <div class="form-group">
                                        <label class="control-label col-lg-4">Instruction Type:</label>
                                        <div class="col-lg-8">
                                            <select name="type" id="type" class="validate[required] form-control col-lg-6">
                                                <option value="">Select Type</option>
                                                <option value="1" <?php if($value->type==1){ echo "selected";}?>>1</option>
                                                <option value="2" <?php if($value->type==2){ echo "selected";}?>>2</option>
           ...
           <a  href="/exam_instructions?quiz_id=<?=$quiz_id;?>">
