        ...
        <div class="col-lg-12">
          <div class="box">
            ...
            <div id="collapse3" class="body">
              <form class="smart-forms" action="/post_instruction?quiz_id=<?php echo $quiz_id?>" method="POST" id="add_instruction">

              <div class="form-group">
                  <label class="control-label col-lg-4"> English Instructions:</label>
                  <div class="col-lg-8">
                    <textarea id="instruction" class="gui-input" name="instruction" placeholder="English Passage"></textarea>
                  </div>
                  <br>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-lg-8">
                    <textarea id="instruction_h" class="gui-input" name="instruction_h" placeholder="Hindi Instructions"></textarea>
                  </div>
                  <br>
                </div> &nbsp;
                 <div class="form-group">
