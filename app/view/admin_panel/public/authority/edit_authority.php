                    ...
                    <div class="box">
                        ...
                        <div id="collapse3" class="body">
                            <?php foreach($authority as $key => $value){ ?>
                                <form  action="<?php echo '/update_authority?admin_id='.$admin->id.'&authority_id='.$value->id ?>" method="POST" id="edit_authority">
                                    <div class="form-group">
                                        <input type="hidden" name="authority_id" id="authority_id" value="<?php echo $value->id ?>">
                                        <label class="control-label col-lg-4"> Authority Name:</label>

                                        <div class="col-lg-8">
                                            <input type="text" id="name" name="name" placeholder="Authority Name" value="<?php echo $value->name;?>" class="form-control col-lg-6">
                                        </div>
                                        <br>
                                    </div>
                                    <br>
...
$("#edit_authority").validate({
    rules: {
        name: "required",
    },
    messages: {
        name: "Please enter your authority name",
    },
