                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div id="collapse3" class="body">
                            <form action="/post_authority?admin_id=<?=$admin->id?>" method="post" id="add_authority">
                                <div class="form-group">
                                    <label class="control-label col-lg-4"> Authority Name:</label>
                                    <div class="col-lg-8">
                                        <input type="text" id="name" name="name" class="form-control col-lg-6" placeholder="Authority Name">
                                    </div>
                                    <br>
                                </div>
                                <br>
