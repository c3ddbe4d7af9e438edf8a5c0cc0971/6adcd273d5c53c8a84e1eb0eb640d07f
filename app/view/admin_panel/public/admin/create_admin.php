                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div id="collapse3" class="body">
                            <form action="/post_admin" method="POST" class="form-horizontal" id="add-admin">
                                <div class="form-group">
                                    <label class="control-label col-lg-4">Name:</label>
                                    <div class="col-lg-8">
                                        <input type="text" id="name" name="name" class="form-control col-lg-6" placeholder="Admin Name">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="email" id="email" name="email" class="form-control col-lg-6" placeholder="Email">
                                    </div>
                                </div>
                                <div class="form-group">
