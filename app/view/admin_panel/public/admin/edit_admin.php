                    ...
                    <div class="box">
                        ...
                        <div id="collapse3" class="body">
                            <?php foreach ($admin_list as $key => $value) { ?>
                                <form action="<?php echo '/update_admin/'.$value->id ?>" method="POST" class="form-horizontal" id="edit-admin">
                                    <div class="form-group">
                                        <label class="control-label col-lg-4">Name:</label>
                                        <div class="col-lg-8">
                                            <input type="text" id="name" name="name" placeholder="Admin Name" value="<?php echo $value->name ?>" class="form-control col-lg-6">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="password" id="cfmPassword" placeholder="Confirm Password" value="<?php echo $value->password;?>" name="cfmPassword" class="form-control col-lg-6">
                                        </div>
                                    </div>
