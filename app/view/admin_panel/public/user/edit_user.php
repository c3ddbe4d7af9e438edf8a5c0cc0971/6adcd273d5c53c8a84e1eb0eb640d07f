                            ...
                            <?php foreach ($users as $key => $value) { ?>
                                <form action="/update_user?user_edit_id=<?=$value->id?>" method="POST"  class="form-horizontal" id="edit_user" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="name" name="name" placeholder="User Name" value="<?php echo $value->name ?>" class="form-control col-lg-6">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-4">Roll Number:</label>
                                        <div class="col-lg-8">
                                            <input type="text" id="roll_num" name="roll_num" placeholder="Roll Number" value="<?php echo $value->roll_num ?>" class="form-control col-lg-6">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-4">Roll Code:</label>
                                        <div class="col-lg-8">
                                            <input type="text" id="roll_code" name="roll_code" placeholder="Roll Code" value="<?php echo $value->roll_code ?>" class="form-control col-lg-6">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-4"> Reference id:</label>
                                        <div class="col-lg-8">
                                            <input type="text" id="reference_id" name="reference_id" placeholder="Reference Id" value="<?php echo $value->reference_id ?>" class="form-control col-lg-6">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-4">Phone:</label>
                                        <div class="col-lg-8">
                                            <input type="text" id="mobile" name="mobile" placeholder="Phone Number" value="<?php echo $value->mobile ?>" class="form-control col-lg-6">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <select name="language" id="language" class="validate[required] form-control col-lg-6">
                                                ...
                                                <option value="1" <?php if($value->language==1) { echo 'selected';}?>>Hindi</option>
                                                <option value="2" <?php if($value->language==2) { echo 'selected';}?>>English</option>
