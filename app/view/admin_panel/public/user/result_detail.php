                ...
                <div class="col-lg-12">
                    <div class="box">
                        <header>
                            ...
                            <h5>Result Details of Users</h5>
                            <a href="/export_result_details?user_id=<?php echo $user_id;?>">
                                    <button type="button" class="btn btn-warning pull-right"> Export User Result List </button></a>
                                    </header>
                                    <div class="panel">
                  <div class="panel-content">
                    
                      <div class="btn-group btn-group-justified">
                       <a href="/view?user_id=<?=$user_id?>" class="btn btn-primary col-sm-3 <?php if($actual_link=='/view?user_id='.$user_id) {echo 'active';} ?>">
                          <i class="glyphicon glyphicon-home"></i>
                          <p>User Details</p>
                        </a>
                        <a href="/result_details?user_id=<?=$user_id?>" class="btn btn-primary col-sm-3 <?php if($actual_link=='/result_details?user_id='.$user_id) {echo 'active';} ?>">
