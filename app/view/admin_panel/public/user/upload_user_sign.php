            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div class="body">
                            <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="/post_user_sign?admin_id=<?=$admin->id?>" class="form-horizontal" method="post" id="user_csv" enctype="multipart/form-data">
                                <input type="file" required="required" id="filesToUpload" name="sign[]" multiple="multiple" accept="image/*" onChange="makeFileList();" />
