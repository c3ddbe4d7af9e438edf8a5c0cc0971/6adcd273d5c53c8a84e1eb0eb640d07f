                ...
                <div class="col-lg-12">
                    <div class="box">
                        <header class="dark">
                            ...
                            <h5>User Details Csv</h5>
                        </header>
                        <div class="body">
                            <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="/post_user_detail_csv?admin_id=<?=$admin->id?>" class="form-horizontal" method="post" id="user_csv" enctype="multipart/form-data">
