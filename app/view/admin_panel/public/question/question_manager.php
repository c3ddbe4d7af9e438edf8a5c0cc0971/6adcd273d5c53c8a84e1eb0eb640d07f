                ...
                <div class="col-lg-12">
                    <div class="box">
                        <header>
                            ...
                            <h5>Question</h5>
                            <a href="/question_export?quiz_id=<?=$quiz_id?>">
                                    <button type="button" class="btn btn-primary pull-left"> Export Question </button></a>
                        </header>
                  ...
                  <div class="panel-content">
                      ...
                      <a href="/quiz_details?quiz_id=<?=$quiz_id?>" class="btn btn-primary col-sm-3 <?php if($actual_link=='/quiz_details?quiz_id='.$quiz_id) {echo 'active';} ?>">
                       ...
                       <a href="/centers?quiz_id=<?=$quiz_id?>" class="btn btn-primary col-sm-3 <?php if($actual_link=='/user_list?quiz_id='.$quizzes[0]->id) {echo 'active';} ?>">
                                ...
                                <tbody>
                                    ...
                                    <?php if($questions!='null') { ?>
                                        <?php foreach($questions as $key => $value){ ?>
                                            <tr>
                                                <td><?php echo ++$i ;?></td>
                                                <td><a href="question_details?question_id=<?php echo $value->id;?>"><?php echo $value->question ;?></a></td>
                                                <td><a href="/user_log?question_id=<?php echo $value->id; ?>"> user logs</a></td>
                                                <td><?php echo $value->ansoption; ?></td>
                                                <td>
                                                    <a href="/edit_question?quiz_id=<?php echo $quiz_id ?>&question_id=<?php echo $value->id?>">
                                                        <button type="button" class="btn btn-primary pull-left">
                                                            <i class="fa fa-pencil-square" aria-hidden="true"></i> Edit </button>
                                                        </a>
                                                        <form onSubmit="if(!confirm('Do you really want to delete?')){return false;}" action="/delete_question?quiz_id=<?php echo $quiz_id ?>&question_id=<?php echo $value->id ?>" method="POST" class="smart-forms">
                                ...
                                <button type="button" class="btn btn-primary"> Back </button></a>
                                            <div class="text-center">
                                                <a href="/upload_csv?quiz_id=<?php echo $quiz_id?>">
                                                    <button type="button" class="btn btn-warning marB30"> Import Exel File </button></a>
                                                    <a href="/add_question?quiz_id=<?php echo $quiz_id ?>">
                                                        <button type="button" class="btn btn-success marB30"> Add Question Manually </button></a>
                                                    <a href="/update_answer_key?quiz_id=<?php echo $quiz_id ?>">
                                                        <button type="button" class="btn btn-primary marB30"> Update Answer Key </button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
