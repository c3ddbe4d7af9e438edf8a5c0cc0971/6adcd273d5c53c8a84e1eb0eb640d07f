                ...
                <div class="col-lg-12">
                    <div class="box">
                        <header class="dark">
                            ...
                            <h5>Update Answer Key</h5>
                        </header>
                        <div class="body">
                            <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="/post_answer_key?quiz_id=<?php echo $quiz_id?>" class="form-horizontal" method="post" enctype="multipart/form-data" id="ques_csv">
