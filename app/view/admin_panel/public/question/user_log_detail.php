...
$quiz_id    =   $data['quiz_id'];
 $user_list_details=$data['user_list_details'];
 //echo '<pre>';print_r($user_list_details);die;
$admin=$data['admin'];
                ...
                <div class="col-lg-12">
                    <div class="box">
                        <header>
                            ...
                            <?php if($user_list_details!='null'){?>
                        <a  href="/user_details?quiz_id=<?=$quiz_id?>&user_id=<?=$user_list_details[0]->user_id?>" class="btn btn-primary col-sm-3 <?php if($actual_link=='/user_details?quiz_id='.$quiz_id.'&user_id='.$user_list_details[0]->user_id) {echo 'active';} ?>">
                          <i class="glyphicon glyphicon-plus"></i>
                          <p>User Details</p>
                        </a>
                        <?php } else {?>
                             <a  href="#" class="btn btn-primary col-sm-3 <?php if($actual_link=='/user_details?user_id='.$user_list_details[0]->user_id) {echo 'active';} ?>">
                          <i class="glyphicon glyphicon-plus"></i>
                          <p>User Details</p>
                          <?php }?>
                           <?php if($user_list_details!='null'){?>
                        <a href="/user_log_details?quiz_id=<?=$quiz_id?>&user_id=<?=$user_list_details[0]->user_id?>" class="btn btn-primary col-sm-3 <?php if($actual_link=='/user_log_details?quiz_id='.$quiz_id.'&user_id='.$user_list_details[0]->user_id) {echo 'active';} ?>">
                          <i class="glyphicon glyphicon-cloud"></i>
                          <p>Questions Details</p>
                        </a>
                         <?php } else {?>
                             <a href="#" class="btn btn-primary col-sm-3 <?php if($actual_link=='/user_log_details?user_id='.$user_list_details[0]->user_id) {echo 'active';} ?>">
                          <i class="glyphicon glyphicon-cloud"></i>
                          <p>Questions Details</p>
                        </a>
                          <?php }?>
                            ...
                            <div id="collapse4" class="body">
                                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php $i=0; ?>
                                        <?php if($user_list_details!='null') { ?>
                                            <?php foreach($user_list_details as $key => $value) {?>
                                                <tr>
                                                
                                                    <td><?php echo ++$i ;?></td>
                                                    <td><?php echo $value->name; ?></td>
                                                    <td><?php echo $value->question; ?></td>
                                                    <td><?php if($value->visited==1){ echo "yes";}else{ echo "no";} ?></td>
                                                    ...
                                                    <?php } else {?>
                                                        <td>
                                                            ...
                                                            <div class="stat_text">
                                                                <strong>User didn't attempt the quiz</strong>
                                                            </div>
                                                        </td>
                                                        <?php }?>
                                                    </tbody>                
                                                </table>
                                                <a  href="user_list?quiz_id=<?=$quiz_id?>">
