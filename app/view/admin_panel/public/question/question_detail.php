                    ...
                    <div class="box">
                        <header>
                            ...
                            <a  href="/edit_question?quiz_id=<?=$questions[0]->quiz_id?>&question_id=<?=$questions[0]->id?>">
                                <button type="button" class="btn btn-warning pull-right"> Edit Quiz </button>
                            </a>
                             <form action="<?php echo '/delete_quiz?quiz_id='.$questions[0]->quiz_id.'&question_id='.$questions[0]->id ?>" method="POST">
