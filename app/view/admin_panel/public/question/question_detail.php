                ...
                <div class="col-lg-12">
                    <div class="box">
                        <header>
                            ...
                            <a  href="/edit_question?quiz_id=<?=$questions[0]->quiz_id?>&question_id=<?=$questions[0]->id?>">
                                <button type="button" class="btn btn-warning pull-right"> Edit Question </button>
                            </a>
                             <form onSubmit="if(!confirm('Do you really want to delete?')){return false;}" action="<?php echo '/delete_quiz?quiz_id='.$questions[0]->quiz_id.'&question_id='.$questions[0]->id ?>" method="POST">
                  ...
                  <div class="panel-content">
                      ...
                      <div class="btn-group btn-group-justified">
                        <a href="/question_details?question_id=<?=$questions[0]->id?>" class="btn btn-primary col-sm-3 <?php if($actual_link=='/question_details?question_id='.$questions[0]->id) {echo 'active';} ?>">
                          <i class="glyphicon glyphicon-plus"></i>
                          <p>Question details</p>
                        </a>
                        <a href="/user_log?question_id=<?=$questions[0]->id?>" class="btn btn-primary col-sm-3 <?php if($actual_link=='/user_log?question_id='.$questions[0]->id) {echo 'active';} ?>">
                            ...
                            <div id="collapse4" class="body">
                                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                   <!--  <thead>
                                    ...
                                    <tr>
                                     <td><b>Passage</b></td>
                                      <td><?=$questions[0]->passage?></td>
                                    </tr>
                                     <tr>
                                     <td><b> Hindi Passage</b></td>
                                      <td><?=$questions[0]->h_passage?></td>
                                    </tr>
                                     <tr>
                                     <td><b>Question</b></td>
                                    ...
                                    <tr>
                                     <td><b> Hindi Question</b></td>
                                      <td><?=$questions[0]->h_question?></td>
                                    </tr>
                                     <tr>
                                      <td><b>Hindi Option A</b></td>
                                      <td><?=$questions[0]->h_A?></td>
                                    </tr>
                                     <tr>
                                      <td><b>Hindi Option B</b></td>
                                      <td><?=$questions[0]->h_B?></td>
                                    </tr>
                                     <tr>
                                      <td><b>Hindi Option C</b></td>
                                      <td><?=$questions[0]->h_C?></td>
                                    </tr>
                                     <tr>
                                      <td><b>Hindi Option D</b></td>
                                      <td><?=$questions[0]->h_D?></td>
                                    </tr>
                                     <tr>
                                      <td><b>Marks </b></td>
                                      <td><?=$questions[0]->marks?></td>
                                    </tr>
                                     <tr>
                                      <td><b>Negative Marks</b></td>
                                      <td><?=$questions[0]->neg_marks?></td>
                                    </tr>
                                                 ...
                                                 <a  href="question_manager?quiz_id=<?=$questions[0]->quiz_id;?>">
