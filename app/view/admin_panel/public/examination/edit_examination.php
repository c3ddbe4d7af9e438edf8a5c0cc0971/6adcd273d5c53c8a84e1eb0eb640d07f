...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="/font-awesome-4.7.0/css/font-awesome.css">
    ...
    <style type="text/css">
     ...
     <script src="/tinymce21-1-17/js/tinymce/tinymce.min.js"></script>
                    ...
                    <div class="box">
                        ...
                        <div id="collapse3" class="body">
                            <?php foreach($examinations as $key => $value) { ?>
                                <form action="<?php echo '/update_examination?authority_id='.$authority_id.'&exam_id='.$value->id ?>" method="POST" id="edit_examination">
                                    <div class="form-group">
                                        <label class="control-label col-lg-4"> Examination Name:</label>
                                        <div class="col-lg-8">
                                            <input type="text" name="examination_name" id="examination_name" placeholder="Examination Name" value="<?php echo $value->examination; ?>"  class="form-control col-lg-6">
                                        </div>
                                        <br>
                                    </div>
                                    &nbsp;<div class="form-group">
                                        <label class="control-label col-lg-4"> Test Description:</label>
                                        <div class="col-lg-8">
                                            <textarea name="examination_desc" placeholder="Test Description" cols="44" class="gui-input"><?php echo $value->description; ?></textarea>
                                        </div>
                                        <br>
                                    </div>
                            ...
                            <a  href="examination?authority_id=<?=$authority_id;?>">
...
$("#edit_examination").validate({
    rules: {
        examination_name: "required",
        examination_desc:"required",
    },
    messages: {
        examination_name: "Please enter Examination name",
        examination_desc: "Please enter Description",
    },
