                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div id="collapse3" class="body">
                            <form action="/post_examination?authority_id=<?php echo $authority_id; ?>" method="post" id="add_examination">
                                <div class="form-group">
                                    <label class="control-label col-lg-4"> Examination Name:</label>
                                    <div class="col-lg-8">
                                        <input type="text" id="examination_name" name="examination_name" class="form-control col-lg-6" placeholder="Examination Name">
                                    </div>
                                    <br>
                                </div>
                                &nbsp;<div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea name="examination_desc" placeholder="Test Description" class="form-control col-lg-6" ></textarea>
                                    </div>
                                    <br>
                                </div>
