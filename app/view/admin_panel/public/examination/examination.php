  ...
  <div class="outer">
    <div class="inner bg-light lter">
      <div class="text-center">
        <a href="/add_examination?authority_id=<?php echo $authority_id; ?>">
          <button type="button" class="btn btn-success pull-right" style="z-index:99;">  
            <i class="fa fa-plus-circle btn_add" aria-hidden="true"></i> Create Examination </button></a>
              <ul class="stats_box">
                  ...
                  <?php foreach($examinations as $key => $value) {?>
                    <a href="/quiz?exam_id=<?php echo $value->id; ?>">  
                      <li class="list_change">
                        ...
                        <div class="stat_text">
                          <strong><?php echo $value->examination?></strong>
                        </div>
                        <a href="/edit_examination?authority_id=<?php echo $authority_id;?>&exam_id=<?php echo $value->id; ?>">
